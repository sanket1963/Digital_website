    ...
    <>
      <div className="container mt-32">
        <div className="grid lg:grid-cols-[66%,34%] gap-4 pr-[15px]">
          <div
            className="h-[200px] md:h-[260px] bg-banner-1 bg-cover
    bg-center rounded-xl p-8 md:p-16"
          >
            <p className="text-topHeadingSecondary text-xl font-medium">
              Sale 20% off all store
            </p>
            <h2 className="text-topHeadingPrimary font-bold text-xl sm:text-3x1 max-w-[240px]">
          ...
          <div className="h-[260px] bg-banner-2  bg-right rounded-xl hidden lg:block"></div>
        </div>
      </div>
    </>
  );
